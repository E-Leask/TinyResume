...
namespace TinyPhysics.Systems
{
    ...
    public class MoveWithKeyboardSystem : SystemBase
    {
        ...
        private void UpdateMovement()
        {
            ...
            if (m_InputSystem.GetKey(KeyCode.A)) moveDirection.z += 1f;
            if (m_InputSystem.GetKey(KeyCode.D)) moveDirection.z -= 1f;
            if (m_InputSystem.GetKey(KeyCode.S)) moveDirection.x -= 1f;
            if (m_InputSystem.GetKey(KeyCode.W)) moveDirection.x += 1f;
